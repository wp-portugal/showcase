...
namespace CPWP\Showcase\Core\Taxonomy\Subject;
...
function taxonomy() {
	$labels = array(
		'name'                       => _x( 'Subjects', 'Taxonomy General Name', 'cpwp_showcase' ),
		'singular_name'              => _x( 'Subject', 'Taxonomy Singular Name', 'cpwp_showcase' ),
		'menu_name'                  => __( 'Subjects', 'cpwp_showcase' ),
	...
	$rewrite = array(
		'slug'                       => sanitize_title( _x( 'Subject', 'Taxonomy slug', 'cpwp_showcase' ) ),
		'with_front'                 => true,
		'hierarchical'               => true,
	);
	...
	register_taxonomy( 'cpwp_subject', array( 'cpwp_showcase' ), $args );
}
